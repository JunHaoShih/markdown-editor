<template>
  <div class="tw-text-center tw-flex tw-flex-col tw-items-center tw-justify-center">
    <div role="status">
      <svg
        aria-hidden="true"
        class="tw-inline tw-w-8 tw-h-8 tw-text-gray-200 tw-animate-spin dark:tw-text-gray-600
        tw-fill-blue-600"
        viewBox="0 0 100 101"
        fill="none"
        ...
        <path
          ...
          25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781
